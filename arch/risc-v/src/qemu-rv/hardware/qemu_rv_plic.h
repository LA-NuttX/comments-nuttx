...
#else
#  define QEMU_RV_PLIC_ENABLE1   (QEMU_RV_PLIC_BASE + 0x002000)//QEMU_RV_PLIC_ENABLE1=0x0c002000
#  define QEMU_RV_PLIC_ENABLE2   (QEMU_RV_PLIC_BASE + 0x002004)//QEMU_RV_PLIC_ENABLE2=0x0c002000
